---
layout: post
title:  "[ECMA Script5] 자바스크립트의 컨셉"
subtitle:   "[ECMA Script5] 자바스크립트의 컨셉"
...
![Ecmascript5](/assets/img/es5.png)
...
```
아마, 어떤 분들은 이번 포스팅을 보면서 더 많이 검색해보면서 공부를 했을 수도 있고, 아닌 분들도 있을 것이다. 물론, 더 많이 찾아보고 개념을 정확히 알고 넘어간다면 도움이 된다.

개인적인 생각으로 코드를 보고 이해를 하다보면 알고 있었던 개념도 새롭게 다가올 때가 있기 때문에 간단하게 알아두고 넘어가는 것도 좋은 공부 방법 중 하나라고 생각한다.

키워드를 아느냐 모르느냐의 차이는 생각보다 클 수 있고 그런 이유에서 이번 포스팅을 올린 것이기 때문에 큰 부담을 느낄 필요는 없다고 생각된다.
```
